...
const float MazePlugin::UNIT = 2.0; //distance between centers of squares
const float MazePlugin::WALL_HEIGHT = 0.5;
const float MazePlugin::WALL_LENGTH = 2.0;
const float MazePlugin::WALL_THICKNESS = 0.10;
const float MazePlugin::BASE_HEIGHT= 0.10;
